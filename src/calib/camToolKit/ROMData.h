...
typedef struct
{
	...
	USHORT sfReadCmdAddr; //20220329
	USHORT sfReadDataStartAddr; //20220329 Read Serial Flash data address
...
extern USHORT sfReadCmdAddr; //20220329
extern USHORT sfReadDataStartAddr; //20220329 Read Serial Flash data address
